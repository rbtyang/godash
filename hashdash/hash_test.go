package hashdash_test

import (
	"github.com/rbtyang/godash/hashdash"
...
func TestMd5(t *testing.T) {
	{
		...
		enStr := hashdash.Md5("hello world 123")
		assert.Equal(t, want, enStr)
	}
	{
		want := "7f797e9a4e2c3a9b190225d299214ce4"
		enStr := hashdash.Md5ByteToStr([]byte("hello world 123"))
		assert.Equal(t, want, enStr)
	}
	{
		want := "078175f6152e6e900c28facbbdfe8b1911db8f1e"
		enStr := hashdash.Sha1("hello world 123")
		assert.Equal(t, want, enStr)
	}
	{
		want := "d4223bf93e202505a6a501421a88d9fa43341f7757e217dd603ccdce157c13bd"
		enStr := hashdash.Sha256("hello world 123")
		assert.Equal(t, want, enStr)
	}
	{
